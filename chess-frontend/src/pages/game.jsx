    ...
    <div className="choose-container">
      ...
      <div className="button-wrapper">
        <button className="game-button"onClick={() => navigate('/chessAi')} >
          <img src="https://res.cloudinary.com/dlbc9t2ft/image/upload/v1744743651/aichess3_eww93a.png" alt="Play vs AI" />
          <br></br>
          <h2 className="option">Play Vs AI</h2>
        </button>
        
        <button className="game-button" onClick={() => navigate('/maingame')}>
          <img src="https://res.cloudinary.com/dlbc9t2ft/image/upload/v1744743093/boychess_wi36yu.png" alt="Play vs Friend" />
          <br></br>
